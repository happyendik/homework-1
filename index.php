...
$age1 = 17;
//переменные лучше называть более информативно 
// например $fullAge
if ($age1 >= 18 && $age1 <= 65) {
    echo "Вам еще работать и работать"; // двойные кавычки избыточны
} elseif ($age1 > 65) {
    echo "Вам пора на пенсию";
} elseif ($age1 >= 1 && $age1 < 18) {      //лучше поставить не 17(как в условии задачи) а 18, т.к. в этом случае не будет выпадать возраст от 17 до 18
